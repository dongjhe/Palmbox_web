...
$(window).on('load', function() {
    ...
    ;(function() {
        ...
        // 櫃機條件篩選開關
        $('.cabinetfilter .arrow .filter,.filterbox .checkbut a').on(
            'click',
            function() {
        ...
        $('.pick_method .form__radio label').on('click', function() {
            ...
            if (pickname == '宅配') {
                $(this)
                    .parents('.orderselect')
                    .find('.logistics_method,.home_address')
                    .css('display', 'block')
                $(this)
                    .parents('.orderselect')
                    .find('.cabinet_address')
                    .css('display', 'none')
            } else {
                $(this)
                    .parents('.orderselect')
        ...
        $(document).on('click', '.vehicle_toggle a', function() {
            ...
            $(this)
                ...
                .addClass('active')
            $(this)
                .parent('.vehicle_toggle')
                .siblings('.vehicle_text')
                .find('div')
                .eq(a_index)
                .fadeIn(0)
                .siblings()
        ...
        function issuelength() {
            for (let index = 0; index <= 4; index++) {
                let h3length = $('.issuebox .issue')
                    .eq(index)
                    .find('h3')
                let expand = $('.issuebox .issue')
                    .eq(index)
                    .find('.expand_more')
